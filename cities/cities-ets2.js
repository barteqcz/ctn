...
// the cities below are included in the base game map.
var cities = [
    {
        "gameName": "aberdeen",
        "realName": "Aberdeen",
...
/*  {
    ...
    {
        "gameName": "trnava (local)",
        "realName": "Trnava (local)",
        "country": "slovakia-west",
        "x": "26441.8",
        "y": "156.246",
        "z": "13133.2"
...
var cities_iberia = [
    ...
    {
        "gameName": "ponte de sor",
        "realName": "Ponte de Sor",
        "country": "portugal",
        "x": "-87009.8",
        "y": "61.3",
        "z": "50122.2"
...
var cities_goingeast = [
    {
        ...
        "realName": "Banská Bystrica (local)",
...
cities = cities.concat(cities_italy_map); //Italy DLC
cities = cities.concat(cities_iberia); //Iberia DLC
cities = cities.concat(cities_scandinavia); //Scandinavia DLC
cities = cities.concat(cities_goingeast); //Going East DLC
cities = cities.concat(cities_gapfillers); //Cities which fill the signal gaps and are not included in any of the above maps
